...
Note: All the main codes are set up to the relative path to be auto adjusted in your working directory, however the path in the vedio below is just my directory for demontration.  
